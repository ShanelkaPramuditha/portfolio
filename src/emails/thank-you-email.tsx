      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={paragraph}>
              I&apos;ve received your message and will review it carefully. I typically respond
            ...
            <Section style={featureBox}>
              ...
              <Text style={featureText}>
                ...
                <br />• Feel free to check out my portfolio in the meantime
              </Text>
            </Section>

            <Text style={paragraph}>
              In the meantime, feel free to explore my portfolio to see more of my work and
              projects.
            </Text>
