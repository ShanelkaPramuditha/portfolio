      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={header}>
            ...
            <Text style={headerSubtitle}>Someone just reached out through your portfolio</Text>
          </Section>
          ...
          <Section style={content}>
            ...
            <Section style={alertBox}>
              <Text style={alertText}>
                ⚡ <strong>Action Required:</strong> A potential client or collaborator is waiting
                for your response!
              </Text>
            </Section>
          ...
          <Section style={footer}>
            <Hr style={footerHr} />
            <Text style={footerText}>This email was sent from your portfolio contact form</Text>
